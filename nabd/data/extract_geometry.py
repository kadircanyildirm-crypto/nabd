...
"""Extract the map furniture for the real-event scene: contours and the rupture.
    ...
    python nabd/data/extract_geometry.py cont_mi.json rupture.json <event-id>
...
EVENT = "us6000jllz"          # overridden by argv[3]
OUT = HERE / f"shakemap-{EVENT}-geo.json"
WINDOW = HERE / f"shakemap-{EVENT}.json"
