...
<section class="slide" id="slide-4">
  ...
  <div class="steps">
    ...
    <div><i>3</i><p>Bu ikisi, aynı anda, <b>bir bölgenin çöküşünün</b> imzasıdır — bir hücre arızasının, bir bakım penceresinin ya da bir kalabalığın değil.</p></div>
  </div>
...
<section class="slide" id="slide-8">
  ...
  <div class="built">
    ...
    <div class="status">
      ...
      <div><b>79 / 79 test, 10 paket</b><span>fuzz değişmezleri, modelin bekçisi ve %1–3 rastgele nöbetçi kopmasında 90 sıradan sabahın 0'ında ilan dahil</span></div>
    </div>
  </div>
</section>""")
...
<section class="slide" id="slide-12">
  ...
  verisidir</b> — 262 sismik istasyon, 1.459 şiddet gözlemi. Bize ait olan yalnızca sarsıntıyı sessizliğe çeviren kural; eşikler de Turkcell'in <b>“bölgedeki 3.300 baz istasyonunun yarısı devre dışı”</b> beyanına kalibre edildi — pencerimiz %63 karanlıkta bitiyor.</p>
</section>""")
...
<section class="slide" id="slide-13">
  ...
  <table class="apit cmp">
    ...
    <tr><td class="api">Eşikler</td><td>Turkcell'in "3.300'ün yarısı devre dışı" beyanına göre ayarlandı</td><td><b>aynı sayılar, dokunulmadı</b> — bir test bunu doğruluyor</td></tr>
